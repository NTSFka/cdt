...
func TestBuilderFallback_BuildTargets_Empty(t *testing.T) {
	...
	err := fallback.BuildTargets(
		t.Context(),
		internal.ProjectBuilderOptions{Targets: &[]string{"target1"}},
	)
	...
	tool1.On(
		...
		mock.MatchedBy(func(opts internal.ProjectBuilderOptions) bool {
			return assert.NotNil(t, opts.Targets) &&
				assert.ElementsMatch(t, *opts.Targets, []string{"target1"})
		}),
	).
		Return(nil)
...
func createCoverageCollectorTool(id string, executable *internal.Executable) *struct {
	internal.ExecutableTool
...
func TestCoverageCollectorFallback_Details_Empty(t *testing.T) {
	fallback := &workflow.CoverageCollectorFallback{}

	assert.Equal(t, "fallback ()", fallback.Details())
}

func TestCoverageCollectorFallback_Details(t *testing.T) {
...
func TestDependencyManagerFallback_AddDependencies_Empty(t *testing.T) {
	...
	err := fallback.AddDependencies(
		t.Context(),
		internal.ProjectDependencyManagerOptions{},
		[]string{"dep1"},
		false,
	)
...
func TestDependencyManagerFallback_RemoveDependencies_Empty(t *testing.T) {
	...
	err := fallback.RemoveDependencies(
		t.Context(),
		internal.ProjectDependencyManagerOptions{},
		[]string{"dep1"},
		false,
...
func TestDependencyManagerFallback_RemoveDependencies_Available1(t *testing.T) {
	...
	tool1.Test(t)
	tool2.Test(t)
	tool1.On("RemoveDependencies", mock.Anything, mock.Anything, []string{"dep1"}, false).
		Return(nil)
...
func TestDependencyManagerFallback_RemoveDependencies_Available2(t *testing.T) {
	...
	tool1.Test(t)
	tool2.Test(t)
	tool2.On("RemoveDependencies", mock.Anything, mock.Anything, []string{"dep1"}, false).
		Return(nil)
...
func TestDependencyManagerFallback_UpdateDependencies_Empty(t *testing.T) {
	...
	err := fallback.UpdateDependencies(
		t.Context(),
		internal.ProjectDependencyManagerOptions{},
		[]string{"dep1"},
	)
...
func TestDependencyManagerFallback_FetchDependencies_Empty(t *testing.T) {
	...
	err := fallback.FetchDependencies(
		t.Context(),
		internal.ProjectDependencyManagerOptions{},
		false,
	)
